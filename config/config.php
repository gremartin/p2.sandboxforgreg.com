...
# What is the name of this app?
	define('APP_NAME', 'Terse Words');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@sandboxforgreg.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'gremartin@yahoo.com'); 

# Default DB name for this app
	define('DB_NAME', 'sandboxf_p2_sandboxforgreg_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'S$z%!9UjSXe(Diceb!zbPhJGz0qi(#JCk_2oL6ua');
	define('TOKEN_SALT', 'IL0nIipHp6VryzgIv(71tYsVweuT&34Oz7l^pqcG');